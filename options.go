...
// WithBaseURL points the client at a self-hosted SMTP Manager instance.
// Without it the client uses the hosted platform, DefaultBaseURL. Paste
// either the Endpoint the console showed when the key was created
...
// "/api/v1/messages" URL, see Client.Endpoint. A blank value, a non-http(s)
// URL or one carrying credentials makes New fail with CodeConfiguration.
